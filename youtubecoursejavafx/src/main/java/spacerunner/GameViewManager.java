...
public class GameViewManager {
    ...
    private final static String BACKGROUND_IMAGE="file:youtubecoursejavafx/src/main/java/spacerunner/resources/purple.png";

    private final static String METEOR_BROWN_IMAGE = "file:youtubecoursejavafx/src/main/java/spacerunner/resources/meteorBrown_med3.png";
    private final static String METEOR_GREY_IMAGE = "file:youtubecoursejavafx/src/main/java/spacerunner/resources/meteorGrey_med2.png";
    ...
    private int points;
    private final static String GOLD_STAR_IMAGE = "file:youtubecoursejavafx/src/main/java/spacerunner/resources/star_gold.png";
    ...
    private void checkIfElementsCollide(){
        if(SHIP_RADIUS+STAR_RADIUS>calulateDistance(ship.getLayoutX()+49,star.getLayoutX()+15,ship.getLayoutY()+37,star.getLayoutY()+15)){
            setNewElementPosition(star);
        ...
        for(int i=0;i<brownMeteors.length;i++){
            if(METEOR_RADIUS>calulateDistance(ship.getLayoutX()+49,brownMeteors[i].getLayoutX()+20,ship.getLayoutY()+37,brownMeteors[i].getLayoutY()+20)){
                removeLife();;
                setNewElementPosition(brownMeteors[i]);
            }
        }
        for(int i=0;i<greyMeteors.length;i++){
            if(METEOR_RADIUS>calulateDistance(ship.getLayoutX()+49,greyMeteors[i].getLayoutX()+20,ship.getLayoutY()+37,brownMeteors[i].getLayoutY()+20)){
                removeLife();;
                setNewElementPosition(greyMeteors[i]);
            }
        }
