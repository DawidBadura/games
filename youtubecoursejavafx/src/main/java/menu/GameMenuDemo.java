...
public class GameMenuDemo extends Application {
    ...
    private Parent createContent() {
        ...
        try (InputStream is = Files.newInputStream(Paths.get("C:\\Users\\Dawid\\IdeaProjects\\Games\\youtubecoursejavafx\\src\\main\\resources\\407472.jpg"))) {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Far Cry 4 Menu Demo");
